      ...
      <section class="xl:bg-contain bg-white">
        <div class="container px-4 mx-auto">
          <nav class="flex justify-between items-center py-6">
            ...
            <ul class="hidden lg:flex lg:items-center lg:w-auto lg:space-x-12">
              <li><a class="text-sm text-blueGray-400 hover:text-blueGray-500" href="/product">Product</a></li>
              <li><a class="text-sm text-blueGray-400 hover:text-blueGray-500" href="/download">Download</a></li>
              <li><a class="text-sm text-blueGray-400 hover:text-blueGray-500" href="/features">Features</a></li>
              <li><a class="text-sm text-blueGray-400 hover:text-blueGray-500" href="/about">About Us</a></li>
            </ul>
        ...
        <div class="hidden navbar-menu relative z-50">
          ...
          <nav class="fixed top-0 left-0 bottom-0 flex flex-col w-5/6 max-w-sm py-6 px-6 bg-white border-r overflow-y-auto">
            ...
            <div>
              <ul>
                <li class="mb-1"><a class="block p-4 text-sm text-blueGray-500 hover:bg-blue-50 hover:text-blue-600" href="/product">Product</a></li>
                <li class="mb-1"><a class="block p-4 text-sm text-blueGray-500 hover:bg-blue-50 hover:text-blue-600" href="/download">Download</a></li>
                <li class="mb-1"><a class="block p-4 text-sm text-blueGray-500 hover:bg-blue-50 hover:text-blue-600" href="/about">About Us</a></li>
                <li class="mb-1"><a class="block p-4 text-sm text-blueGray-500 hover:bg-blue-50 hover:text-blue-600" href="/features">Features</a></li>
              </ul>
      ...
      <nav id="footer" class="bg-gray-500">
        <div class="container mx-auto pt-8 pb-4">
          <div class="flex flex-wrap overflow-hidden sm:-mx-1 md:-mx-px lg:-mx-2 xl:-mx-2">
            ...
            <div class="w-full overflow-hidden sm:my-1 sm:px-1 sm:w-1/2 md:my-px md:px-px md:w-1/2 lg:my-2 lg:px-2 lg:w-1/4 xl:my-2 xl:px-2 xl:w-1/4 pb-6">
               <h4 class="text-white"><a href="/product">Product</a></h4>
            </div>
            <div class="w-full overflow-hidden sm:my-1 sm:px-1 sm:w-1/2 md:my-px md:px-px md:w-1/2 lg:my-2 lg:px-2 lg:w-1/4 xl:my-2 xl:px-2 xl:w-1/4 pb-6">
                <h4 class="text-white"><a href="/download">Download</a></h4>
            </div>
            <div class="w-full overflow-hidden sm:my-1 sm:px-1 sm:w-1/2 md:my-px md:px-px md:w-1/2 lg:my-2 lg:px-2 lg:w-1/4 xl:my-2 xl:px-2 xl:w-1/4 pb-6">
                <h4 class="text-white"><a href="/about">About Us</a></h4>
            </div>
          </div>
